  ...
  render() {
    return (
      <Card centered>
        ...
        <Card.Content>
          <Card.Header>
            {this.filterUndefined("text", this.props.selectedPractitioner)}
          </Card.Header>
          <Card.Meta>
          ...
          <Card.Description>
            ...
            Favourite Animal:{" "}
            <b>
              {this.filterUndefined("favouriteAnimal", this.props.backendInfo)}
            </b>
            <br />
            Gender:{" "}
            <b>
              {this.filterUndefined("gender", this.props.selectedPractitioner)}
            </b>
            <br />
            Birthday:{" "}
            <b>
