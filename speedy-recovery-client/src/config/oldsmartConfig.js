const smartSandboxConfigs = {
  ...
  parentSandbox_1:
    "https://launch.smarthealthit.org/v/r3/sim/eyJrIjoiMSIsImoiOiIxIiwiYiI6ImRhMTg4ZWY0LTA5YmUtNDY0OC1hY2YxLTVkMDc3YmY2NjhkMSJ9/fhir"
};

// objects
const oldsmartConfig = {
  client: {
