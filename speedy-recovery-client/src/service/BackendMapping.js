import {
    mapMessagesMySQL,mapConversationsMySQL
} from "./BackendMappingAdapterMySQL";

const conversationMap = (conversationResource, id, conversationList, dbType) => {
    if (dbType) {
      switch (dbType) {
        case "MySQL":
        return mapConversationsMySQL(conversationResource, id, conversationList);
        case "2":  
        default:
